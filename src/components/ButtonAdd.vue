...
<template>
  <button :disabled="!plus" class="button button_secondary">
    <svg v-if="plus" class="icon" fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
